...
class SpecialoffersController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Specialoffers'];
			if($model->save())
	...
	{
		$model=new Specialoffers('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Specialoffers']))
			$model->attributes=$_GET['Specialoffers'];
	...
	{
		$model=Specialoffers::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='specialoffers-form')
		{
