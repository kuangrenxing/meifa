    ...
    <td class="box3_m00" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    	...
    	foreach($model as $i=>$v):?>
			...
			<td align="left" valign="top">					
				...
				<a href="<?php echo Yii::app()->createUrl('hairstyleshow/view',array('id'=>$v['id']));?>">
					...
					<table height="132" width="160" align="left" border="0" cellspacing="0" cellpadding="0" class="product_frame">
				         <tbody><tr>
				            <td valign="top" align="left">		
				 				<a href="<?php echo Yii::app()->createUrl('hairstyleshow/view',array('id'=>$v['id']));?>"><img src="./images/bg2.gif" width="164" height="136"></a>			
							 </td>
				         	</tr>
				    	</tbody>
				    </table> 
				...
				<p class="product_list_title"><a href="http://t.mobanku.com/00846/product_view.asp?id=305&bid=25&sid=175"><?php echo $v['hairstylename'];?></a></p>
